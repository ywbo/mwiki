...
## [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#键值对数据库是怎么实现的)键值对数据库是怎么实现的？
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#c-语言字符串的缺陷)C 语言字符串的缺陷

C 语言的字符串其实就是一个字符数组，即数组中每个元素是字符串中的一个字符。

比如，下图就是字符串“xiaolin”的 char* 字符数组的结构：

![img](https://img-blog.csdnimg.cn/img_convert/376128646c75a893ad47914858fa2131.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/bcf6bde3b647bdc343efcbc1a8f10579.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/6286480eb1840a8930e18fd215d82565.png)
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#sds-结构设计)SDS 结构设计
...
#### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#o-1-复杂度获取字符串长度)O（1）复杂度获取字符串长度

C 语言的字符串长度获取 strlen 函数，需要通过遍历的方式来统计字符串长度，时间复杂度是 O（N）。

而 Redis 的 SDS 结构因为加入了 len 成员变量，那么**获取字符串长度的时候，直接返回这个成员变量的值就行，所以复杂度只有 O（1）**。

#### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#二进制安全)二进制安全
...
#### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#不会发生缓冲区溢出)不会发生缓冲区溢出
...
#### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#节省内存空间)节省内存空间
...
![img](https://img-blog.csdnimg.cn/img_convert/47e6c8fbc17fd6c89bdfcb5eedaaacff.png)

可以看得出，这是按照实际占用字节数进行分配内存的，这样可以节省内存空间。

------

## [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#链表)链表

大家最熟悉的数据结构除了数组之外，我相信就是链表了。

Redis 的 List 对象的底层实现之一就是链表。C 语言本身没有链表这个数据结构的，所以 Redis 自己设计了一个链表数据结构。

### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#链表节点结构设计)链表节点结构设计
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#链表结构设计)链表结构设计
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#链表的优势与缺陷)链表的优势与缺陷
...
## [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#压缩列表)压缩列表
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#压缩列表结构设计)压缩列表结构设计
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#连锁更新)连锁更新
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#压缩列表的缺陷)压缩列表的缺陷
...
## [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#哈希表)哈希表
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#哈希表结构设计)哈希表结构设计
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#哈希冲突)哈希冲突
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#链式哈希)链式哈希
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#渐进式-rehash)渐进式 rehash
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#rehash-触发条件)rehash 触发条件
...
## [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#整数集合)整数集合

整数集合是 Set 对象的底层实现之一。当一个 Set 对象只包含整数值元素，并且元素数量不大时，就会使用整数集这个数据结构作为底层实现。

### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#整数集合结构设计)整数集合结构设计
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#整数集合的升级操作)整数集合的升级操作
...
![img](https://img-blog.csdnimg.cn/img_convert/5dbdfa7cfbdd1d12a4d9458c6c90d472.png)
...
## [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#跳表)跳表
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#quicklist-结构设计)quicklist 结构设计
...
### [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#listpack-结构设计)listpack 结构设计

listpack 采用了压缩列表的很多优秀的设计，比如还是用一块连续的内存空间来紧凑地保存数据，并且为了节省内存的开销，listpack 节点会采用不同的编码方式保存不同大小的数据。

我们先看看 listpack 结构：

![img](https://img-blog.csdnimg.cn/img_convert/4d2dc376b5fd68dae70d9284ae82b73a.png)
...
## [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#总结)总结
...
## [#](https://xiaolincoding.com/redis/data_struct/data_struct.html#读者问答)读者问答
